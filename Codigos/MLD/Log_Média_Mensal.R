...
#   labs(x="Mês", y = "Log da média mensal dos dias que choveu")+
...
#   labs(x="Log da média mensal dos dias que choveu", y = "Densidade")+
...
prev = previsao_segunda_ordem(y,dlmy, meses = 6, dados_treino, "ln_Media_dias_chuva")
